...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Water.amount'
        db.alter_column(u'ratlog_water', 'amount', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Water.amount'
        db.alter_column(u'ratlog_water', 'amount', self.gf('django.db.models.fields.FloatField')(default=1000))
